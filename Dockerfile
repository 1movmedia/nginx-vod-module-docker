...
ARG NGINX_CONFIG="--with-http_ssl_module --with-file-aio --with-threads --with-cc-opt=-O3"
ARG NGINX_DEPS=""
...
ARG NGINX_DEPS_RUNTIME=""

RUN apk add --no-cache ca-certificates openssl pcre zlib ffmpeg ${NGINX_DEPS_RUNTIME}
